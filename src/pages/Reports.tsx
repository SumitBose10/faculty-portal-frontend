import { FileText, Download, TrendingUp, Users, Calendar, BarChart } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="bg-gradient-primary text-white border-0">
          <CardHeader className="pb-2">
            <CardDescription className="text-white/80">Reports Generated</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">48</div>
            <div className="text-sm text-white/70">This semester</div>
          </CardContent>
        </Card>
